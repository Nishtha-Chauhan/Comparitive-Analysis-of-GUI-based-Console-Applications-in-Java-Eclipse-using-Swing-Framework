...
public class CoForm extends JFrame {
	static CoForm frame;
	...
	public CoForm() {
		...
		JLabel lb = new JLabel("ADD COORDINATOR");
		...
		b.addActionListener(new ActionListener() {
			...
			int i=CoDb.save(name, password, email, address, city, contact);
			if(i>0){
				JOptionPane.showMessageDialog(CoForm.this,"Coordinator added successfully!");
				AdminPortal.main(new String[]{});
				frame.dispose();
				
			}else{
				JOptionPane.showMessageDialog(CoForm.this,"Sorry, unable to save!");
			}
			}
		});
