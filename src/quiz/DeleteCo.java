...
public class DeleteCo extends JFrame {
	static DeleteCo frame;
		...
		b.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(sid==null||sid.trim().equals("")){
					JOptionPane.showMessageDialog(DeleteCo.this,"Id can't be blank");
				}else{
					int id=Integer.parseInt(sid);
					int i=CoDb.delete(id);
					if(i>0){
						JOptionPane.showMessageDialog(DeleteCo.this,"Record deleted successfully!");
					}else{
						JOptionPane.showMessageDialog(DeleteCo.this,"Unable to delete given id!");
					}
				}
			}
		});
