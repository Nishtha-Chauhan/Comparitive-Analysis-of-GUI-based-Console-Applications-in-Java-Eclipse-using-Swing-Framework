...
public class DeleteSup extends JFrame {
	static DeleteSup frame;
		...
		b.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(sid==null||sid.trim().equals("")){
					JOptionPane.showMessageDialog(DeleteSup.this,"Id can't be blank");
				}else{
					int id=Integer.parseInt(sid);
					int i=SupplierDb.delete(id);
					if(i>0){
						JOptionPane.showMessageDialog(DeleteSup.this,"Record deleted successfully!");
					}else{
						JOptionPane.showMessageDialog(DeleteSup.this,"Unable to delete given id!");
					}
				}
			}
		});
